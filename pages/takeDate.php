...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,300;0,400;0,700;1,200&family=Roboto:wght@100&display=swap" rel="stylesheet">
...
<body>
  ...
  <header class="container-fluid bg-dark">
    ...
    <nav class=" navbar d-none d-sm-flex container justify-content-start bg-white" id="firstNavbar">
        ...
        <ul class="navbar-nav ms-auto flex-row">
          <li class="nav-item me-3">
            <a class="nav-link" href="https://www.instagram.com/enes.caliskan9/"><i class="social-link fa-brands fa-instagram fa-lg" style="color: #ac1ba7;"></i></a>
          </li >
          <li class="nav-item" style="margin-right: 30px;">
            <a class="nav-link " href="https://wa.me/+905323555754"><i class="social-link fa-brands fa-whatsapp fa-lg" style="color: #20d924;"></i></a>
          </li>
        </ul>
    </nav>
    <!--İkinci Navbar-->
    ...
    <div class="container text-white">
      <p class="justify-content-center d-flex mb-5">Sıra almak için uygun saatlerimiz 10:00 - 20:00 arasıdır.Eğer bu saatler arasında müsait zaman bulabilirseniz sıra alabilirsiniz.</p>
    ...
    <div class="container-fluid d-flex text-white" id="footer">
      ...
      <div class="container d-flex align-items-center mt-2 mb-2" id="footerSection1">
        ...
        <a class=" nav-link callLink" style="margin-left: auto;" href="tel:+905323555754"><i class="fa fa-mobile me-2" ></i>Ara 5323555754</a>
      </div>
      ...
      <div class="container-fluid d-flex row mt-3">
        ...
        <div class="col footerCol">
          ...
          <ul class="mt-5">
            ...
            <li class="mt-3" style="margin-left: 2rem; list-style: none;"><i class="fa-regular fa-envelope me-1"></i><a style="color:white;text-decoration: none;" href="mailto:cihatabayli@test.com">cihatabayli@test.com</a></li>
            <li class="mt-3" style="margin-left: 2rem; list-style: none;"><i class="fa-brands fa-whatsapp me-1 "></i><a style="color:white;text-decoration: none;" href="https://wa.me/5323555754">Whatsapp'dan ulaş!</a></li>
          </ul>
        </div>
